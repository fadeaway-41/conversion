...
const audioExtension = Object.keys(CODECS) as CODEC[];

let type = " video/" as string;

export default function UploadBox({ handleFileChange} : UploadBoxProps) 
{
    return (
